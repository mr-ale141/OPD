...
void print_D(sf::RenderWindow *window, float x, float y) {
    ...
    convex.setPoint(2, {WIDTH_ALPHA / 2 + x + 4 * (WIDTH_ALPHA / 20), y + (float) 1.5 * (HIGHT_ALPHA / 25)});
    ...
    convex.setPoint(9, {WIDTH_ALPHA / 2 + x + 4 * (WIDTH_ALPHA / 20), y + (float) 23.5 * (HIGHT_ALPHA / 25)});
